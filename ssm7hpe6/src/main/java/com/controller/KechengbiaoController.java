...
public class KechengbiaoController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,KechengbiaoEntity kechengbiao, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("xuesheng")) {
			kechengbiao.setXuehao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("jiaoshi")) {
			kechengbiao.setGonghao((String)request.getSession().getAttribute("username"));
		}
