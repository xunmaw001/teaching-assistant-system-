	...
	<view class="content">
		<form class="app-update-pv">
				...
				<input :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0.19)","borderColor":"rgba(51, 153, 153, 1)","borderRadius":"16rpx","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' :disabled="ro.xueshengxingming" v-model="ruleForm.xueshengxingming" placeholder="学生姓名"></input>
																					...
																					<view :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(51, 153, 153, 1)","margin":"0 0 10rpx 0","borderWidth":"2rpx","borderStyle":"solid","height":"108rpx"}' class="cu-form-group select">
				<view :style='{"width":"160rpx","fontSize":"28rpx","color":"rgba(51, 153, 153, 1)","textAlign":"left"}' class="title">考勤状况</view>
				<picker @change="kaoqinzhuangkuangChange" :value="kaoqinzhuangkuangIndex" :range="kaoqinzhuangkuangOptions">
					<view :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(51, 153, 153, 1)","borderRadius":"16rpx","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' class="uni-input">{{ruleForm.kaoqinzhuangkuang?ruleForm.kaoqinzhuangkuang:"请选择考勤状况"}}</view>
				</picker>
			</view>
												<view :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(51, 153, 153, 1)","margin":"0 0 10rpx 0","borderWidth":"2rpx","borderStyle":"solid","height":"108rpx"}' class="cu-form-group select">
				<view :style='{"width":"160rpx","fontSize":"28rpx","color":"rgba(51, 153, 153, 1)","textAlign":"left"}' class="title">考勤日期</view>
				<picker mode="date" :value="ruleForm.kaoqinriqi" @change="kaoqinriqiChange">
					<view :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(51, 153, 153, 1)","borderRadius":"16rpx","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' class="uni-input">{{ruleForm.kaoqinriqi?ruleForm.kaoqinriqi:"请选择考勤日期"}}</view>
				</picker>
			</view>
												<view :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(51, 153, 153, 1)","margin":"0 0 10rpx 0","borderWidth":"2rpx","borderStyle":"solid","height":"108rpx"}' class="cu-form-group">
			...
			<!-- 否 -->
				...
				<view :style='{"width":"160rpx","fontSize":"28rpx","color":"rgba(51, 153, 153, 1)","textAlign":"left"}' class="title">考勤内容</view>
				<textarea :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(51, 153, 153, 1)","borderRadius":"16rpx","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"280rpx"}' v-model="ruleForm.kaoqinneirong" placeholder="考勤内容"></textarea>
			</view>
	...
	export default {
				...
				ruleForm: {
												mingcheng: '',
																...
																userid: '',
																												...
																												xuehaoOptions: [],
				xuehaoIndex: 0,
																																kaoqinzhuangkuangOptions: [],
				kaoqinzhuangkuangIndex: 0,
																																												// 登陆用户信息
				user: {},
                                ro:{
                                   mingcheng : false,
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`kaoqinxinxi`, this.ruleForm.id);
			...
			if(options.cross){
				...
				for (var o in obj){
					...
					if(o=='kaoqinneirong'){
					this.ruleForm.kaoqinneirong = obj[o];
					this.ro.kaoqinneirong = true;
					continue;
					}
					if(o=='kaoqinzhuangkuang'){
					this.ruleForm.kaoqinzhuangkuang = obj[o];
					this.ro.kaoqinzhuangkuang = true;
					continue;
					}
					if(o=='kaoqinriqi'){
					this.ruleForm.kaoqinriqi = obj[o];
					this.ro.kaoqinriqi = true;
					continue;
					}
					if(o=='gonghao'){
		...
		methods: {
			...
			// 多级联动参数
																																													...
																																													kaoqinriqiChange(e) {
				this.ruleForm.kaoqinriqi = e.target.value;
				this.$forceUpdate();
			},
																								
																																																															
																																							// 下拉变化
			kaoqinzhuangkuangChange(e) {
				this.kaoqinzhuangkuangIndex = e.target.value
				this.ruleForm.kaoqinzhuangkuang = this.kaoqinzhuangkuangOptions[this.kaoqinzhuangkuangIndex]
			},
			...
			async onSubmitTap() {
					...
					return
																																				...
																																				if(this.ruleForm.id){
					await this.$api.update(`kaoqinxinxi`, this.ruleForm);
				}else{
					await this.$api.add(`kaoqinxinxi`, this.ruleForm);
				}
