  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="学生姓名" prop="xueshengxingming">
              <el-input v-model="ruleForm.xueshengxingming" 
                placeholder="学生姓名" readonly></el-input>
                                                                  ...
                                                                  <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="考勤状况" prop="kaoqinzhuangkuang">
          <el-select v-model="ruleForm.kaoqinzhuangkuang" placeholder="请选择考勤状况">
            <el-option
                v-for="(item,index) in kaoqinzhuangkuangOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="考勤状况" prop="kaoqinzhuangkuang">
	      <el-input v-model="ruleForm.kaoqinzhuangkuang"
                placeholder="考勤状况" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="考勤日期" prop="kaoqinriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.kaoqinriqi" 
                type="date"
                placeholder="考勤日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.kaoqinriqi" label="考勤日期" prop="kaoqinriqi">
              <el-input v-model="ruleForm.kaoqinriqi" 
                placeholder="考勤日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="教师姓名" prop="jiaoshixingming">
              <el-input v-model="ruleForm.jiaoshixingming" 
                placeholder="教师姓名" readonly></el-input>
                                                                                ...
                                                                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="考勤内容" prop="kaoqinneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="考勤内容"
                  v-model="ruleForm.kaoqinneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.kaoqinneirong" label="考勤内容" prop="kaoqinneirong">
                    <span>{{ruleForm.kaoqinneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
