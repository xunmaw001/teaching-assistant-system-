  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" v-if="ruleForm.qingjiariqi" label="请假日期" prop="qingjiariqi">
              <el-input v-model="ruleForm.qingjiariqi" 
                placeholder="请假日期" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="结束日期" prop="jieshuriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jieshuriqi" label="结束日期" prop="jieshuriqi">
              <el-input v-model="ruleForm.jieshuriqi" 
                placeholder="结束日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
