          ...
          <el-form-item class="input" label="教师姓名" prop="jiaoshixingming">
              <el-input v-model="ruleForm.jiaoshixingming" 
                placeholder="教师姓名" readonly></el-input>
                                                                  ...
                                                                  <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="预警内容" prop="yujingneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="预警内容"
                  v-model="ruleForm.yujingneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yujingneirong" label="预警内容" prop="yujingneirong">
                    <span>{{ruleForm.yujingneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
